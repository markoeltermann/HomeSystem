...
namespace TestApp
{
    ...
    internal static class TestParser
    {
        ...
        internal static (TuyaCommand, int, string?) DecodeResponse(byte[] data, byte[] key, TuyaProtocolVersion protocolVersion = TuyaProtocolVersion.V33)
        {
